...
const localeInfo = {
  'en-US': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('/Users/dipengchao/relx-middle-end/src/locales/en-US.ts')),...((locale) => locale.__esModule ? locale.default : locale)(require('/Users/dipengchao/relx-middle-end/src/pages/user/login/locales/en-US.ts')),
    },
    locale: 'en-US',
  ...
  'pt-BR': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('/Users/dipengchao/relx-middle-end/src/locales/pt-BR.ts')),
    },
    locale: 'pt-BR',
  ...
  'zh-CN': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('/Users/dipengchao/relx-middle-end/src/locales/zh-CN.ts')),...((locale) => locale.__esModule ? locale.default : locale)(require('/Users/dipengchao/relx-middle-end/src/pages/user/login/locales/zh-CN.ts')),
    },
    locale: 'zh-CN',
  ...
  'zh-TW': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('/Users/dipengchao/relx-middle-end/src/locales/zh-TW.ts')),...((locale) => locale.__esModule ? locale.default : locale)(require('/Users/dipengchao/relx-middle-end/src/pages/user/login/locales/zh-TW.ts')),
    },
    locale: 'zh-TW',
